(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
  1: [function (require, module, exports) {
    ...
    windows_1["default"].loadData = function (data) {
      ...
      if (data == "" || data == null || data == undefined || data == " ") {
        $("#noDataImg").attr("src",hosts.imgHost+"/upload/files/master/2020/09/22/162638811.png");
        $(".empty_data").show();
      } else {
        var html = "<h2>" + data.Title + "简介</h2>";
        html += data.Content;
        $("#introduction_box").html(html);
      }
    };
  }, { "../../../gulp/mobile/booksMethod": 7, "../../../gulp/win/windows": 9, "./../../../gulp/getQueryString/GetQueryString": 3, "./../../../gulp/headerData/headerData": 4 }], 2: [function (require, module, exports) {
    "use strict";
    /// <reference path="../../gulp/tsd/jquery.d.ts" />
  ...
  }, { "./../consts/const": 2, "./molieInit": 8 }], 8: [function (require, module, exports) {
    "use strict";
    exports.__esModule = true;
    var Ios = require("./Ios");
  ...
  }, { "./../consts/const": 2, "./../zepto/zepto.js": 10, "./Android": 5, "./Ios": 6 }], 9: [function (require, module, exports) {
    (function (global) {
      "use strict";
      exports.__esModule = true;
      var win;
