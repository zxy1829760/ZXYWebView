    ...
    windows_1["default"].loadData = function (data) {
      ...
      if (data.Title && data.Title != "") {
        ...
        var topHtml = '<div class="new_title">' +
          ...
          '<img class="news_platform_logo" src="' + data.EntBroker.LogoFive + '"/>' +
          '<span class="new_platform_name">' + data.Organiser + ' | </span>' +
          (data.AddTime ? '<span class="publish_time">' + globalTimeLimit_1["default"](data.AddTime) + '</span>' : '') +
          '</div>';
